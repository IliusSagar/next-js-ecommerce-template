...
export default function Navbar() {
  return (
    <header className="w-full sticky top-0 z-50 shadow-md">
      ...
      {/* ------------------ TOPBAR ------------------ */}
      <div className="bg-gray-100 text-gray-700 px-4 py-1 flex justify-between items-center text-sm">
        {/* Left: contact */}
      ...
      <div className="bg-white px-4 py-3 flex items-center justify-between max-w-7xl mx-auto">
        ...
        <nav className="hidden md:flex items-center gap-6 text-gray-700 font-medium">
          ...
          <Link href="/category" className="hover:text-black transition">Category</Link>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden md:flex items-center border rounded-full overflow-hidden">
            ...
            />
            <button className="bg-black text-white px-3 py-1 hover:bg-gray-800 transition">
              Search
            </button>
          </div>
          ...
          {/* Login */}
          <Link href="/login" className="flex items-center gap-1 bg-black text-white px-3 py-1.5 rounded-full hover:bg-gray-800 transition">
            <User size={16} /> Login
          </Link>
        </div>
